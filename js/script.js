...
const iconLinks = document.querySelectorAll(".icon-link"),
      ...
      rules = ["Вкажіть заголовок для залучення уваги волонтерів та детально опишіть вид необхідної допомоги.",
            "Якщо характер допомоги є гумунітарним: збір продовольства або медична допомога, то задля відстежування " +
            "прогресу вкажіть усі необхідні ресурси у таблиці.",
            "Оберіть вашу локацію (місце збору гуманітарної допомоги, зустрічі для перевезення).", 
            "Оберіть дату та час завершення заявки.",
            "Напишіть у цій секції додаткові контактні дані, " +
            "розкажіть більш детально про вашу організацію (необов’язково)."];
